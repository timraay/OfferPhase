...
from draftphase.utils import async_ttl_cache
...
class GameStateError(Exception):
    """Raised when attempting to perform an action that is not available in the current state of a game"""
...
async def get_command_mention(tree: discord.app_commands.CommandTree, name: str, subcommands: str | None = None):
